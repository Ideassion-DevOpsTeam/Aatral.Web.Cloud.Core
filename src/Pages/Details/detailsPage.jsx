    ...
    <section className="details pos-rel">
      ...
      <section className="details__main-cont wid-80 m-x-auto">
        <div className="details__main-cont__content-box">
          ...
          <main>
            <p>Aatral, a pivotal part of Tamil RISE, is a vibrant community, specifically designed for Tamil IT entrepreneurs and professionals seeking to connect, thrive and expand their horizons.</p>
