...
import FatherImage from "../../assets/Images/details_father.png";
    ...
    <section className="details pos-rel">
      ...
      <section className="details__main-cont wid-80 m-x-auto">
        <div className="details__main-cont__content-box">
          ...
          <main>
            <p>
              A pivotal part of Tamil RISE, is a vibrant community, specifically
              designed for Tamil IT entrepreneurs seeking to connect, thrive and
              expand their horizons.
            </p>
            <p>
              By understanding challenges and opportunities inherent in the
              dynamic IT industry we have created a nurturing environment where
              like-minded individuals can come together to share insights, forge
              partnerships, and inspire one another to reach new heights of
              success.
            </p>
            <p>
              Whether you're a seasoned entrepreneur or just starting out,
              you'll find support, and gain access to resources, mentorship, and
        ...
        >
          <div>
            ...
            <Image src={FatherImage} title="detailsFatherImage" />
          </div>
        </div>
      </section>
