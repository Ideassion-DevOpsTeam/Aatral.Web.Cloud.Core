...
const aatralStore = (set, get) => ({
  ...
  aatral_top_sec_desc_cont: {
    ...
    desc: "A dynamic arm of The RISE, is an emerging circuit of collective leadership among National Tamil IT entrepreneurs, professionals, executives, and decision- makers, dedicated to transforming the IT ecosystem for sustained future growth.",
  },
  aatral_details: {
    heading_first: "Why",
    heading_last: "aatral-India ?",
